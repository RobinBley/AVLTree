/**GraphViz 							        	JDK 1.7                    		
 * Name: Jannik Weibrecht und Tobias Cordes 		Class: DQI08
 * Programname: GraphViz.java							Date: 27.11.2011               
 * Version: 1.0                          
 * OS: Windows 7   
 */
...
public class GraphViz {
	...
	//private static String TEMP_DIR = "/tmp"; // Linux + MAC
...
//	private static String DOT = "/usr/local/bin/dot"; // Mac
	//private static String DOT = "D:\\Programme\\Graphviz\\bin\\dot.exe"; // Windows
	...
	/**
	 * Where is the dot-program located?
	 */
	...
	/**
	 * Constructor: creates a new GraphViz object that will contain a graph.
	 * String contains the path to the external dot-Program
	 */
	public GraphViz(String dotPath_) {
		this.dotPath = dotPath_;
	}
	...
	private byte[] get_img_stream(File dot, String type) {
		...
		try {
			...
			String[] args = { dotPath, "-T" + type, dot.getAbsolutePath(), "-o",
					img.getAbsolutePath() };
